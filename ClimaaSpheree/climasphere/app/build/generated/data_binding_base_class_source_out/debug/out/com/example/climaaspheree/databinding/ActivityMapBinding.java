...
public final class ActivityMapBinding implements ViewBinding {
  ...
  private ActivityMapBinding(@NonNull RelativeLayout rootView, @NonNull ImageView btnBack,
      @NonNull CardView mapCard, @NonNull TextView tvMapSubtitle, @NonNull TextView tvMapTitle) {
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapBinding((RelativeLayout) rootView, btnBack, mapCard, tvMapSubtitle,
          tvMapTitle);
    }

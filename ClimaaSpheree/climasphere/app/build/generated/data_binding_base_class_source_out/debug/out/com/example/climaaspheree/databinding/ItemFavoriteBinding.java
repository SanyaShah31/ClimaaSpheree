...
public final class ItemFavoriteBinding implements ViewBinding {
  ...
  private ItemFavoriteBinding(@NonNull LinearLayout rootView, @NonNull TextView tvFavoriteName) {
  ...
  public static ItemFavoriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFavoriteBinding((LinearLayout) rootView, tvFavoriteName);
    }
